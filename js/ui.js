...
const UI = (() => {
  ...
  function _applyEditGridLayout() {
    ...
    const cols = isPortrait ? 2 : _editCols;
    grid.dataset.cols = String(cols);
    grid.style.setProperty('--edit-cols', String(cols));
    if (isPortrait) {
      grid.style.setProperty('--edit-card-pad', '6px');
      grid.style.setProperty('--edit-card-gap', '2px');
      grid.style.setProperty('--edit-title-size', '11px');
      grid.style.setProperty('--edit-artist-size', '10px');
      grid.style.setProperty('--edit-date-size', '9px');
      grid.style.setProperty('--edit-tag-size', '9px');
    } else if (cols === 6) {
